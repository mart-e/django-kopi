...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KopiComment.content_owner'
        db.add_column('comments_kopicomment', 'content_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KopiComment.content_owner'
        db.delete_column('comments_kopicomment', 'content_owner')
    ...
    models = {
        ...
        'comments.kopicomment': {
            'Meta': {'ordering': "('submit_date',)", 'object_name': 'KopiComment', '_ormbases': ['comments.Comment']},
            ...
            'content_owner': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'identifier': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'session_id': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
