...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'KopiComment'
        db.create_table('comments_kopicomment', (
            ...
            ('session_id', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('comments', ['KopiComment'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'KopiComment'
        db.delete_table('comments_kopicomment')
